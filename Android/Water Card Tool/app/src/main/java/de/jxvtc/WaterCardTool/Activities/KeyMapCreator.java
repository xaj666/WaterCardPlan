...
import de.jxvtc.WaterCardTool.Activities.Preferences.Preference;
...
public class KeyMapCreator extends BasicActivity {
    ...
    public final static String EXTRA_KEYS_DIR =
        "de.jxvtc.WaterCardTool.Activity.KEYS_DIR";
    ...
    public final static String EXTRA_SECTOR_CHOOSER =
        "de.jxvtc.WaterCardTool.Activity.SECTOR_CHOOSER";
    /**
