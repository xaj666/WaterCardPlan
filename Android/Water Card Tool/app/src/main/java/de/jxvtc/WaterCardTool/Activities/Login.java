...
public class Login extends Activity {
    ...
    private static String API_COUNT = "https://150.158.85.14:4867/api/count";
    private  static String API_INFO = "https://150.158.85.14:4867/api/announcement";
            ...
            if (keysArray != null) {
                for (String key : keysArray) {
                    if (editText.getText().toString().equals(key)) {
                        ...
                        API_NAME = "https://150.158.85.14:4867/api/GetName?secret_key=" + key;
                        API_Score = "https://150.158.85.14:4867/api/GetScore?secret_key=" + key;
                        SeverKey = key;
    ...
    public static class ApiManager {
        ...
        private static class DeductScoreTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String apiUrl = "https://150.158.85.14:4867/api/deductScore/" + key;
